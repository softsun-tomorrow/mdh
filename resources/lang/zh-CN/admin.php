...
return [
    ...
    'configx' => [
        ...
        'base' => [
            ...
            'site_logo' => '网站logo',
            'site_open' => '网站开关',
            'store_apply_account' => '商户入驻费用',
            'apply_discount' => '商家入驻小区长邀请减免金额',
            'normal_user_sign' => ' 普通用户签到获得麦穗',
            'vip_user_sign' => '代理签到领取麦穗',
            'tyfon_coin' => '发布心情消耗麦穗',
            'flash_sale_changci' => '抢购场次',
            'lottery_max_num' => '最多抽奖次数',
            'coin2rmb' => '麦穗比例',
            'sign_extra_reward' => '连签额外奖励',
            'lottery_limit_num' => '分享最多抽奖次数',
        ],
